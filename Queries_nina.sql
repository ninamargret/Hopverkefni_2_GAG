...
-- For people that have	been	investigated	by exactly 3	different	agents, select their ID, name and gender as well as how	 many	 years 	it has	been	since	they were last investigated. The last column should	 be named “yearsSinceLastInvestigation” Please note that some people	 involved in a crime	 are not investigated, and that The Bureau is operating	in the current year: 2045.
